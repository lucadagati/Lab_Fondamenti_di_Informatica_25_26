...
8. `es08_export_web_plot.m`  
   Export grafico su file web-friendly (`.png`, `.svg`) + pagina HTML locale opzionale.
...
- Export web senza dipendenze esterne  
  - `exportgraphics` / `saveas` per PNG, SVG
  - generazione di una semplice pagina HTML locale che include l'immagine
